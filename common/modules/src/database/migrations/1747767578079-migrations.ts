...
export class Migrations1747767578079 implements MigrationInterface {
    name = 'Migrations1747767578079'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "books" ADD "social_description" jsonb DEFAULT '{}'::jsonb`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "books" DROP COLUMN "social_description"`);
    }
