...
export class Migrations1760265708635 implements MigrationInterface {
    name = 'Migrations1760265708635'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bill_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" uuid, "updated_by" uuid, "deleted_by" uuid, "name" character varying NOT NULL, "quantity" integer NOT NULL, "price" numeric(10,2) NOT NULL, "total" numeric(10,2) NOT NULL, "billId" uuid, CONSTRAINT "PK_729cb3e07036682e6695f4bac3f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_729cb3e07036682e6695f4bac3" ON "bill_items" ("id") `);
        await queryRunner.query(`CREATE INDEX "IDX_8b65a6482f6e228c66f99b762f" ON "bill_items" ("created_at") `);
        await queryRunner.query(`CREATE TABLE "group_members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" uuid, "updated_by" uuid, "deleted_by" uuid, "role" "public"."group_members_role_enum" NOT NULL DEFAULT 'member', "status" "public"."group_members_status_enum" NOT NULL DEFAULT 'invited', "invitedAt" TIMESTAMP DEFAULT now(), "leftAt" TIMESTAMP WITH TIME ZONE, "joinedAt" TIMESTAMP NOT NULL DEFAULT now(), "groupId" uuid, "userId" uuid, "invitedById" uuid, "leftById" uuid, CONSTRAINT "UQ_53f644f66a416c1542b743c0295" UNIQUE ("groupId", "userId"), CONSTRAINT "PK_86446139b2c96bfd0f3b8638852" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_86446139b2c96bfd0f3b863885" ON "group_members" ("id") `);
        await queryRunner.query(`CREATE INDEX "IDX_d5cfe4b416cc86c9aa75335b6e" ON "group_members" ("created_at") `);
        await queryRunner.query(`CREATE TABLE "message_reads" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" uuid, "updated_by" uuid, "deleted_by" uuid, "readAt" TIMESTAMP NOT NULL DEFAULT now(), "messageId" uuid, "userId" uuid, CONSTRAINT "UQ_9f3112be42aa2424337e15e5ae9" UNIQUE ("messageId", "userId"), CONSTRAINT "PK_7d3be462a9d7dfbbccc93c097e1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_7d3be462a9d7dfbbccc93c097e" ON "message_reads" ("id") `);
        await queryRunner.query(`CREATE INDEX "IDX_b8b43e386470eb2357de1001c4" ON "message_reads" ("created_at") `);
        await queryRunner.query(`CREATE TABLE "messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" uuid, "updated_by" uuid, "deleted_by" uuid, "content" text NOT NULL, "groupId" uuid, "senderId" uuid, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_18325f38ae6de43878487eff98" ON "messages" ("id") `);
        await queryRunner.query(`CREATE INDEX "IDX_0777b63da90c27d6ed993dc60b" ON "messages" ("created_at") `);
        await queryRunner.query(`CREATE TABLE "groups" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" uuid, "updated_by" uuid, "deleted_by" uuid, "name" character varying NOT NULL, "slug" character varying NOT NULL, "description" character varying, "avatar" character varying, CONSTRAINT "UQ_eccfe767267171ae21e7cbf183d" UNIQUE ("slug"), CONSTRAINT "PK_659d1483316afb28afd3a90646e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_659d1483316afb28afd3a90646" ON "groups" ("id") `);
        await queryRunner.query(`CREATE INDEX "IDX_2c77c18a08d4f88da652075f0a" ON "groups" ("created_at") `);
        await queryRunner.query(`CREATE TABLE "bills" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" uuid, "updated_by" uuid, "deleted_by" uuid, "title" character varying NOT NULL, "totalAmount" numeric(10,2) NOT NULL, "note" character varying, "groupId" uuid, "payerId" uuid, CONSTRAINT "PK_a56215dfcb525755ec832cc80b7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_a56215dfcb525755ec832cc80b" ON "bills" ("id") `);
        await queryRunner.query(`CREATE INDEX "IDX_d356b6c69f9227a2cd697ffe9f" ON "bills" ("created_at") `);
        await queryRunner.query(`CREATE TABLE "bill_shares" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" uuid, "updated_by" uuid, "deleted_by" uuid, "amount" numeric(10,2) NOT NULL, "isPaid" boolean NOT NULL DEFAULT false, "billId" uuid, "userId" uuid, CONSTRAINT "UQ_0fbaf6342490683bb741efca75a" UNIQUE ("billId", "userId"), CONSTRAINT "PK_40c42873b6fbc87e891b03e429c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_40c42873b6fbc87e891b03e429" ON "bill_shares" ("id") `);
        await queryRunner.query(`CREATE INDEX "IDX_5cff3e196f4bed110d12e8efed" ON "bill_shares" ("created_at") `);
        ...
        await queryRunner.query(`ALTER TABLE "bill_items" ADD CONSTRAINT "FK_b58e05ac79f151ff015d70e122e" FOREIGN KEY ("billId") REFERENCES "bills"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "group_members" ADD CONSTRAINT "FK_d098ecaccb886e601cc6bab76a4" FOREIGN KEY ("invitedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "group_members" ADD CONSTRAINT "FK_d986fd5930479a30eb2c951129c" FOREIGN KEY ("leftById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "bills" ADD CONSTRAINT "FK_cae7051a42b00aca17ee139bde0" FOREIGN KEY ("groupId") REFERENCES "groups"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bills" ADD CONSTRAINT "FK_3606ced5cac3d4affb6e71f0185" FOREIGN KEY ("payerId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bill_shares" ADD CONSTRAINT "FK_5336fe9891fde26e768b619de45" FOREIGN KEY ("billId") REFERENCES "bills"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bill_shares" ADD CONSTRAINT "FK_8ba0158bc2e8a07496b1f98ce27" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bill_shares" DROP CONSTRAINT "FK_8ba0158bc2e8a07496b1f98ce27"`);
        await queryRunner.query(`ALTER TABLE "bill_shares" DROP CONSTRAINT "FK_5336fe9891fde26e768b619de45"`);
        await queryRunner.query(`ALTER TABLE "bills" DROP CONSTRAINT "FK_3606ced5cac3d4affb6e71f0185"`);
        await queryRunner.query(`ALTER TABLE "bills" DROP CONSTRAINT "FK_cae7051a42b00aca17ee139bde0"`);
        ...
        await queryRunner.query(`ALTER TABLE "group_members" DROP CONSTRAINT "FK_d986fd5930479a30eb2c951129c"`);
        await queryRunner.query(`ALTER TABLE "group_members" DROP CONSTRAINT "FK_d098ecaccb886e601cc6bab76a4"`);
        ...
        await queryRunner.query(`ALTER TABLE "bill_items" DROP CONSTRAINT "FK_b58e05ac79f151ff015d70e122e"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5cff3e196f4bed110d12e8efed"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_40c42873b6fbc87e891b03e429"`);
        await queryRunner.query(`DROP TABLE "bill_shares"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d356b6c69f9227a2cd697ffe9f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a56215dfcb525755ec832cc80b"`);
        await queryRunner.query(`DROP TABLE "bills"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2c77c18a08d4f88da652075f0a"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_18325f38ae6de43878487eff98"`);
        await queryRunner.query(`DROP TABLE "messages"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b8b43e386470eb2357de1001c4"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7d3be462a9d7dfbbccc93c097e"`);
        await queryRunner.query(`DROP TABLE "message_reads"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d5cfe4b416cc86c9aa75335b6e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_86446139b2c96bfd0f3b863885"`);
        await queryRunner.query(`DROP TABLE "group_members"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8b65a6482f6e228c66f99b762f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_729cb3e07036682e6695f4bac3"`);
